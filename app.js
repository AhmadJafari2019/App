...
let UIController = (function() {
    ...
    // Format the number of exp and inc
    ...
    return {
        ...
        //  Write the function changedType for the EXP type.
...
let controller = (function(budgetCtrl, UICtrl) {
    ...
    let ctrlAddItem = function() {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            UICtrl.addListItem(newItem, input.type, input.description, input.value);
